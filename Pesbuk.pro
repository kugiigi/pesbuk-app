...
UBUNTU_TRANSLATION_DOMAIN="pesbuk.kugiigi"
...
aptest.commands = bash $$PWD/pesbuk/tests/autopilot/run
aptest.depends  = sub-pesbuk

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pesbuk/tests/unit
unittest.depends  = sub-pesbuk
